...
const MenuElement = (arg) => {
  ...
  return (
    <ul>
      <li className="menu-items"><button type="button">{home}</button></li>
      <li className="menu-items"><button type="button">{about}</button></li>
      <li className="menu-items"><button type="button">{contact}</button></li>
    </ul>
  );
};
